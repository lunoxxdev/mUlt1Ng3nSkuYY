...
REPO="https://github.com/lunoxxdev/mUlt1Ng3nSkuYY/main/"
...
sleep 2
clear
wget https://raw.githubusercontent.com/lunoxxdev/mUlt1Ng3nSkuYY/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
clear
wget https://raw.githubusercontent.com/lunoxxdev/mUlt1Ng3nSkuYY/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
